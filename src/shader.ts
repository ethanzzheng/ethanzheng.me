// "Mesh drift" background — 21st.dev Shader Builder recipe, exact packed
// uniforms. WebGL1, fullscreen triangle, no libraries. If WebGL is
// unavailable the canvas is removed and the page keeps its white background.
...
if (!glMaybe) {
  canvas.remove();
  throw new Error("webgl unavailable — shader background skipped");
}
const gl = glMaybe;
